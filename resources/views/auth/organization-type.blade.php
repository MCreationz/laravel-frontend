...
@section('content')
    ...
    <div class="form-wrap">
        <div class="card-box mb-4 position-relative selected">
            <div class="card-wrap p-3">
                <div class="d-flex align-items-center gap-3 mb-3">
                    <div class="gradient-icon">
                        <img src="img/non-profit.png" alt="non profit" width="" height="">
                    </div>
                    <div class="flex-1">
                        <h3 class="mb-0">Non-Profit Organisation</h3>
                    </div>
                </div>
                <p class="mb-2">Access curated funding calls powered by CSR Foundations, Social Impact Funds, Philanthropy
                    &
                    Family Offices.</p>
                <a href="#" class="simple-link">
                    Register as NPO <svg xmlns="http://www.w3.org/2000/svg" width="15" height="7" viewBox="0 0 15 7"
                        fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            fill="url(#paint0_linear_4317_1107)" />
                        <defs>
                            <linearGradient id="paint0_linear_4317_1107" x1="4.05182" y1="4.34478" x2="8.06922"
                                y2="0.350854" gradientUnits="userSpaceOnUse">
        ...
        <div class="card-box mt-2 position-relative">
            <div class="card-wrap p-3">
                <div class="d-flex align-items-center gap-3 mb-3">
                    <div class="gradient-icon">
                        <img src="img/startup.png" alt="non profit" width="" height="">
                    </div>
                    <div class="flex-1">
                        <h3 class="mb-0">Startup</h3>
                    </div>
                </div>
                <p class="mb-2">Access active funding calls powered by top Incubators and Venture Capitalists.</p>
                <a href="#" class="simple-link">
                    Register as Startup <svg xmlns="http://www.w3.org/2000/svg" width="15" height="7"
