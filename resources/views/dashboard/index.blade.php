        ...
        <div class="dashboard-v2-summary-card mb-3">
            <div class="dashboard-v2-summary-grid">
                <div class="dashboard-v2-org">
                    ...
                    <h2 class="dashboard-v2-name mb-1">{{ auth('organization')->user()->organization_name ?? 'Nirmaan Foundation' }}</h2>
                    ...
                    <tbody>
                        @for ($i = 0; $i < 6; $i++)
                            <tr>
                                ...
                                <td>
                                    <div class="tag-wrap">
                                        <span class="tag-pill">AI For Good</span>
                                        <span class="tag-pill">AI in Health</span>
                                        <span class="tag-pill">AI in Defence</span>
                                        <span class="tag-pill plus">+2</span>
                                    </div>
                                </td>
                                <td>
                                    <div class="status-wrap">
                                        <span class="status-pill">Fund Outlay: ₹5 Crore</span>
                                        <span class="status-pill">Fund Type: Multi-portion</span>
                                        <span class="status-pill">Per Entity Cap: Upto ₹1 Crore</span>
                                        <span class="status-pill plus">+2</span>
                                    </div>
                                </td>
                                <td class="text-end">
                                    <div class="dashboard-v2-action">
                                        <a href="#" class="btn btn-primary dashboard-v2-apply">Apply Now</a>
                                        <a href="{{ route('projects.details') }}" class="dashboard-v2-view-link">View Details</a>
                                    </div>
                                </td>
                            </tr>
                        @endfor
