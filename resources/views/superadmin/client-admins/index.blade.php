                        ...
                        <tr>
                            ...
                            <td class="action-btn">
                                ...
                                <div class="btn-group gap-1">
                                    ...
                                    <!-- View -->
                                    <a href="{{ route('superadmin.client-admins.show', $clientAdmin->id) }}" class="view-btn">
                                    ...
                                    <!-- Edit -->
                                    <button type="button" class="edit-btn edit-client-admin" data-id="{{ $clientAdmin->id }}"
            ...
            <div class="modal-content p-3">
                ...
                <div class="modal-header border-0 pb-0">
                    <div>
                        ...
                        <h2 class="modal-title mb-1 inner-title fw-bold" id="clientAdminModalTitle" style="color: #0d6efd;">
                            Add Client Admin
                        </h2>
                    ...
                    <form id="clientAdminForm" action="{{ route('superadmin.client-admins.store') }}" method="POST">
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control py-2" id="organization_name" name="organization_name"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="select-wrapper w-100 position-relative">
                                    ...
                                    <div
                                        ...
                                        <span class="dropdown-arrow" style="color: #0d6efd;">▼</span>
                                    </div>
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="select-wrapper w-100 position-relative">
                                    ...
                                    <ul class="select-list" style="display: none; max-height: 250px; overflow-y: auto;">
                        ...
                        <div class="modal-footer border-0 d-flex justify-content-end gap-3 pt-0">
                            ...
                            <button type="button" class="btn btn-light px-5 py-2 rounded-pill border"
                                data-bs-dismiss="modal" style="background-color: #f8f9fa;">
                                Cancel
                            </button>

                            <!-- SUBMIT BUTTON -->

                            <button type="submit" id="clientAdminSubmitBtn" class="btn text-white px-5 py-2 rounded-pill"
