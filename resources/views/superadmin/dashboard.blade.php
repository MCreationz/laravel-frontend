...
$activeFunds = \App\Models\Fund::where('status', 'active')
                ...
                <div class="col-12 col-lg-7 d-flex flex-wrap gap-1 justify-content-lg-end">
                    ...
                    <div class="col">
                        <div class="dashboard-v2-kpi">
                            <p class="mb-0 value">{{ number_format($totalClients) }}</p>
                            <p class="mb-0 label">Client Admins</p>
                        </div>
                    </div>

                    <div class="col">
                        <div class="dashboard-v2-kpi">
                            <p class="mb-0 value">{{ $totalApplicants }}</p>
                            <p class="mb-0 label">Applicants</p>
                        </div>
                    </div>

                    <div class="col">
                        <div class="dashboard-v2-kpi">
                            <p class="mb-0 value">{{ $activeFunds }}</p>
                            <p class="mb-0 label">Active Funds</p>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="dashboard-v2-kpi">
                            <p class="mb-0 value">{{ $totalReviewers }}</p>
                            <p class="mb-0 label">Reviewers</p>
                        </div>
                    </div>
