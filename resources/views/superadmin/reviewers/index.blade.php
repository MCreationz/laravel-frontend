        ...
        <table class="table align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($reviewer->funds->isNotEmpty())
                        <span class="badge bg-success-subtle text-success">
                            {{ $reviewer->funds->pluck('fund_name')->implode(', ') }}
                        </span>
                        @else
                    ...
                    <td class="action-btn">
                        <div class="btn-group gap-1">
                            ...
                            {{-- DELETE --}}
                            <form action="{{ route('superadmin.reviewers.delete', $reviewer->id) }}"
                                method="POST" onsubmit="return confirm('Delete this reviewer?')">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body p-0">
                ...
                <form id="reviewerForm" action="{{ route('superadmin.reviewers.store') }}" method="POST">
