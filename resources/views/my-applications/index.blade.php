                    ...
                    @forelse($applications as $application)
                        ...
                        <tr>
                            ...
                            <td class="text-center action-btn">
                                <a href="javascript:void(0)" class="edit-btn view-application" data-bs-toggle="modal"
                                    data-bs-target="#viewApplication" data-fund="{{ $application->fund->fund_name ?? '-' }}"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header border-0"
                style="border-bottom: 1px solid rgb(0 0 0 / 10%) !important">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.view-application').forEach(button => {
        ...
        button.addEventListener('click', function () {
            ...
            document.getElementById('modalFundShort').textContent =
