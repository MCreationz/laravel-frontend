                            ...
                            <td class="action-btn">
                                <div class="btn-group gap-1">
                                    ...
                                    <button class="btn btn-sm btn-primary assign-fund-btn" data-id="{{ $reviewer->id }}"
                                        data-bs-toggle="modal" data-bs-target="#assignFundModal">
                                        Assign Fund
                                    </button>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body p-3">
                    ...
                    <form id="assignFundForm" method="POST" action="{{ route('client-admin.reviewers.assign-funds') }}">
                        ...
                        <div class="select-wrapper w-100 position-relative checkbox-wrap fund-wrap">
                            ...
                            <ul class="select-list checkbox-list">
                                ...
                                @foreach($funds as $fund)
                                    <li>
                                        <input type="checkbox" value="{{ $fund->id }}" id="fund_{{ $fund->id }}"
                                            class="fund-checkbox">
