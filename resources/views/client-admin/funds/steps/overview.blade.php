...
<input type="text"
       ...
       value="{{ old('fund_name', $fund?->fund_name) }}">                            <div class="error-message text-danger" style="display:none;"></div>
                        </div>
