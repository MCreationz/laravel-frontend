            ...
            <div style="border-radius:8px 8px 0px 0px;" class="card p-3 p-md-4 border-0">
                ...
                <div class="row mb-3 flex-wrap row-gap-3 row-gap-md-4 px-md-1">
                    ...
                    <div class="col-12 px-md-2">
                        ...
                        <textarea
                            ...
                            id="about">{{ old('about_fund', $fund?->about_fund) }}</textarea>
                    </div>
                ...
                <div id="fund-timelines-section">
                    ...
                    <div class="row mb-3 flex-wrap row-gap-3 row-gap-md-4 px-md-1">
                        ...
                        <div id="project-start-wrapper" class="col-12 col-md-6 px-md-2">
                        ...
                        <div id="project-end-wrapper" class="col-12 col-md-6 px-md-2">
                        ...
                        <div id="maximum-duration-wrapper" class="col-12 px-md-2">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function toggleProjectTimeline() {
            ...
            const projectStartWrapper = document.getElementById('project-start-wrapper');
            const projectEndWrapper = document.getElementById('project-end-wrapper');
            const maximumDurationWrapper = document.getElementById('maximum-duration-wrapper');

            // Always show the timeline section because project_end is required
            timelineSection.style.display = '';

            if (fundScope.value === 'outside') {
                // Outside: show only Application Closes On
                projectStartWrapper.style.display = 'none';
                projectEndWrapper.style.display = '';
                maximumDurationWrapper.style.display = 'none';
            } else {
                // Other scopes: show all timeline fields
                projectStartWrapper.style.display = '';
                projectEndWrapper.style.display = '';
                maximumDurationWrapper.style.display = '';
            }
        }
