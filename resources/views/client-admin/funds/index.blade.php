    ...
    <div class="card-box bg-white rounded">
        ...
        <div class="top-search-wrap p-3 mb-2">
            <div class="row justify-content-between align-items-center row-gap-2">
                ...
                <div class="col-auto">
                    <a href="{{ route('client-admin.funds.overview') }}" class="btn btn-primary add-btn">
                        + Create Fund
                    </a>
                </div>
                <div class="col-12">
                    <form method="GET" action="{{ route('client-admin.funds.index') }}"
                        class="col-12 col-lg-10 top-fields d-flex gap-2  align-items-center flex-wrap flex-sm-nowrap">

                        <!-- Search -->
                        <div class="search-bar input-group flex-nowrap position-relative" style="max-width:664px;">
                        ...
                        <tr>
                            ...
                            <td class="action-btn">
                                ...
                                <div class="btn-group gap-1">
                                    ...
                                    <!-- Edit -->
                                    <a href="{{ route('client-admin.funds.edit', $fund->id) }}" class="edit-btn">
