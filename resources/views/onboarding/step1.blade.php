            ...
            <form method="POST" action="{{ route('onboarding.step1.store') }}">
                ...
                <div class="row mb-3 flex-wrap row-gap-4">
                    ...
                    <div class="col-6 col-xl-4 px-2">
                        ...
                        <input type="text" name="legal_name" class="form-control" placeholder="Enter legal organization name" required>
                    </div>

                    <div class="col-6 col-xl-4 px-2">
                        <label class="form-label">Date of Incorporation / Registration as per PAN<span>*</span></label>
                        <input type="date" name="date_of_incorporation" class="form-control" placeholder="Select date" required>
                    </div>

                    <div class="col-6 col-xl-4 px-2">
                        <label class="form-label">Brand / Operating Name (if different)</label>
                        <input type="text" name="brand_name" class="form-control" placeholder="Enter brand or operating name">
                    </div>
