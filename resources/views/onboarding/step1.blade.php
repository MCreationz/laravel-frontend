...
<script>
    $(document).ready(function() {
        ...
        $('#pan_number').on('input', function() {
            ...
            window.pendingPan = pan;

            const modal = new bootstrap.Modal(document.getElementById('confirmPanModal'));
            modal.show();
        });

        $('#confirmPanVerification').on('click', function() {

            const pan = window.pendingPan;

            if (!pan || verificationInProgress || panVerified) {
                return;
            }

            bootstrap.Modal.getInstance(document.getElementById('confirmPanModal')).hide();
...
<div class="modal fade" id="confirmPanModal" tabindex="-1" aria-labelledby="confirmPanModalLabel" aria-hidden="true">
            ...
            <div class="modal-body p-0">
                <div class="p-3 px-lg-4 text-center">
                    ...
                    <div class="edit-top-icon mb-3">
                        <img src="{{ asset('img/edit-icon.png') }}" alt="Edit Icon">
                    </div>

                    <h2 class="modal-title mb-2 inner-title" id="confirmPanModalLabel">
