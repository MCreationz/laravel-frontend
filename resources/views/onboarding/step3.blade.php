        ...
        <div style="border-radius:0px;" class="card p-3 p-md-4 border-0 mb-3 rounded-3">
            ...
            <div class="row mb-3 flex-wrap row-gap-3 row-gap-md-4 px-md-1">
                ...
                <div class="col-12 col-md-6 col-xl-4 px-md-2">
                    ...
                    $selectedDomains = old(
                    'domain_of_expertise',
                    $operationalDetail->domain_of_expertise ?? '',
                    );
                    ...
                    <div class="select-wrapper w-100 position-relative checkbox-wrap">
                        ...
                        <ul class="select-list checkbox-list" id="domainCheckboxList">
                            ...
                            <li>
                                <input type="checkbox" value="School Education (Primary & Secondary)" id="d1"
                                    {{ in_array('School Education (Primary & Secondary)', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d1">School Education (Primary & Secondary)</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Higher Education Support" id="d2"
                                    {{ in_array('Higher Education Support', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d2">Higher Education Support</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Scholarships & Fellowships" id="d3"
                                    {{ in_array('Scholarships & Fellowships', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d3">Scholarships & Fellowships</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Digital Education" id="d4"
                                    {{ in_array('Digital Education', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d4">Digital Education</label>
                            </li>

                            <li>
                                <input type="checkbox" value="STEM Education" id="d5"
                                    {{ in_array('STEM Education', $selectedDomains) ? 'checked' : '' }}>
                            ...
                            <li>
                                <input type="checkbox" value="Special Education (Children with Disabilities)"
                                    id="d6"
                                    {{ in_array('Special Education (Children with Disabilities)', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d6">Special Education (Children with Disabilities)</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Vocational Training & Skill Development"
                                    id="d7"
                                    {{ in_array('Vocational Training & Skill Development', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d7">Vocational Training & Skill Development</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Employability & Livelihood Programs" id="d8"
                                    {{ in_array('Employability & Livelihood Programs', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d8">Employability & Livelihood Programs</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Primary Healthcare" id="d9"
                                    {{ in_array('Primary Healthcare', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d9">Primary Healthcare</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Maternal & Child Health" id="d10"
                                    {{ in_array('Maternal & Child Health', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d10">Maternal & Child Health</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Nutrition & Malnutrition" id="d11"
                                    {{ in_array('Nutrition & Malnutrition', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d11">Nutrition & Malnutrition</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Mental Health" id="d12"
                                    {{ in_array('Mental Health', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d12">Mental Health</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Disability Rehabilitation" id="d13"
                                    {{ in_array('Disability Rehabilitation', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d13">Disability Rehabilitation</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Public Health & Sanitation" id="d14"
                                    {{ in_array('Public Health & Sanitation', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d14">Public Health & Sanitation</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Preventive Healthcare & Awareness" id="d15"
                                    {{ in_array('Preventive Healthcare & Awareness', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d15">Preventive Healthcare & Awareness</label>
                            </li>

                            <li>
                                <input type="checkbox" value="HIV/AIDS & Communicable Diseases" id="d16"
                                    {{ in_array('HIV/AIDS & Communicable Diseases', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d16">HIV/AIDS & Communicable Diseases</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Women Empowerment" id="d17"
                                    {{ in_array('Women Empowerment', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d17">Women Empowerment</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Gender Equality" id="d18"
                                    {{ in_array('Gender Equality', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d18">Gender Equality</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Prevention of Domestic Violence" id="d19"
                                    {{ in_array('Prevention of Domestic Violence', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d19">Prevention of Domestic Violence</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Girl Child Development" id="d20"
                                    {{ in_array('Girl Child Development', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d20">Girl Child Development</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Child Protection & Child Rights" id="d21"
                                    {{ in_array('Child Protection & Child Rights', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d21">Child Protection & Child Rights</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Rural Livelihoods" id="d22"
                                    {{ in_array('Rural Livelihoods', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d22">Rural Livelihoods</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Urban Livelihoods" id="d23"
                                    {{ in_array('Urban Livelihoods', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d23">Urban Livelihoods</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Self-Help Groups (SHGs)" id="d24"
                                    {{ in_array('Self-Help Groups (SHGs)', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d24">Self-Help Groups (SHGs)</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Microfinance & Financial Inclusion" id="d25"
                                    {{ in_array('Microfinance & Financial Inclusion', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d25">Microfinance & Financial Inclusion</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Entrepreneurship Development" id="d26"
                                    {{ in_array('Entrepreneurship Development', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d26">Entrepreneurship Development</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Environmental Conservation" id="d27"
                                    {{ in_array('Environmental Conservation', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d27">Environmental Conservation</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Climate Action" id="d28"
                                    {{ in_array('Climate Action', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d28">Climate Action</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Afforestation" id="d29"
                                    {{ in_array('Afforestation', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d29">Afforestation</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Water Conservation" id="d30"
                                    {{ in_array('Water Conservation', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d30">Water Conservation</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Waste Management" id="d31"
                                    {{ in_array('Waste Management', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d31">Waste Management</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Renewable Energy Access" id="d32"
                                    {{ in_array('Renewable Energy Access', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d32">Renewable Energy Access</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Biodiversity Protection" id="d33"
                                    {{ in_array('Biodiversity Protection', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d33">Biodiversity Protection</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Rural Development Projects" id="d34"
                                    {{ in_array('Rural Development Projects', $selectedDomains) ? 'checked' : '' }}>
                            ...
                            <li>
                                <input type="checkbox" value="Infrastructure Development (Community Assets)"
                                    id="d35"
                                    {{ in_array('Infrastructure Development (Community Assets)', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d35">Infrastructure Development (Community Assets)</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Drinking Water Projects" id="d36"
                                    {{ in_array('Drinking Water Projects', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d36">Drinking Water Projects</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Sanitation & Hygiene (WASH)" id="d37"
                                    {{ in_array('Sanitation & Hygiene (WASH)', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d37">Sanitation & Hygiene (WASH)</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Human Rights" id="d38"
                                    {{ in_array('Human Rights', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d38">Human Rights</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Legal Aid & Access to Justice" id="d39"
                                    {{ in_array('Legal Aid & Access to Justice', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d39">Legal Aid & Access to Justice</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Governance & Civic Participation" id="d40"
                                    {{ in_array('Governance & Civic Participation', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d40">Governance & Civic Participation</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Transparency & Accountability" id="d41"
                                    {{ in_array('Transparency & Accountability', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d41">Transparency & Accountability</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Senior Citizens Welfare" id="d42"
                                    {{ in_array('Senior Citizens Welfare', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d42">Senior Citizens Welfare</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Persons with Disabilities" id="d43"
                                    {{ in_array('Persons with Disabilities', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d43">Persons with Disabilities</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Tribal Development" id="d44"
                                    {{ in_array('Tribal Development', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d44">Tribal Development</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Minority Welfare" id="d45"
                                    {{ in_array('Minority Welfare', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d45">Minority Welfare</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Migrant Workers Support" id="d46"
                                    {{ in_array('Migrant Workers Support', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d46">Migrant Workers Support</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Disaster Relief & Rehabilitation" id="d47"
                                    {{ in_array('Disaster Relief & Rehabilitation', $selectedDomains) ? 'checked' : '' }}>
                                <label for="d47">Disaster Relief & Rehabilitation</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Emergency Response & Humanitarian Aid"
                                    id="d48"
                                    {{ in_array('Emergency Response & Humanitarian Aid', $selectedDomains) ? 'checked' : '' }}>
                ...
                <div class="col-12 col-md-6 {{ $role === 'fund_seeker' ? 'col-xl-6' : 'col-xl-4' }} px-md-2">
                    ...
                    <div class="select-wrapper w-100 position-relative checkbox-wrap">
                        ...
                        <ul class="select-list checkbox-list">
                            ...
                            <li>
                                <input type="checkbox" value="Pan India" id="s0"
                                    {{ in_array('Pan India', $selectedStates) ? 'checked' : '' }}>
                                <label for="s0">Pan India</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Andhra Pradesh" id="s1"
                                    {{ in_array('Andhra Pradesh', $selectedStates) ? 'checked' : '' }}>
                                <label for="s1">Andhra Pradesh</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Arunachal Pradesh" id="s2"
                                    {{ in_array('Arunachal Pradesh', $selectedStates) ? 'checked' : '' }}>
                                <label for="s2">Arunachal Pradesh</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Assam" id="s3"
                                    {{ in_array('Assam', $selectedStates) ? 'checked' : '' }}>
                                <label for="s3">Assam</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Bihar" id="s4"
                                    {{ in_array('Bihar', $selectedStates) ? 'checked' : '' }}>
                                <label for="s4">Bihar</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Chhattisgarh" id="s5"
                                    {{ in_array('Chhattisgarh', $selectedStates) ? 'checked' : '' }}>
                                <label for="s5">Chhattisgarh</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Goa" id="s6"
                                    {{ in_array('Goa', $selectedStates) ? 'checked' : '' }}>
                                <label for="s6">Goa</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Gujarat" id="s7"
                                    {{ in_array('Gujarat', $selectedStates) ? 'checked' : '' }}>
                                <label for="s7">Gujarat</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Haryana" id="s8"
                                    {{ in_array('Haryana', $selectedStates) ? 'checked' : '' }}>
                                <label for="s8">Haryana</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Himachal Pradesh" id="s9"
                                    {{ in_array('Himachal Pradesh', $selectedStates) ? 'checked' : '' }}>
                                <label for="s9">Himachal Pradesh</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Jharkhand" id="s10"
                                    {{ in_array('Jharkhand', $selectedStates) ? 'checked' : '' }}>
                                <label for="s10">Jharkhand</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Karnataka" id="s11"
                                    {{ in_array('Karnataka', $selectedStates) ? 'checked' : '' }}>
                                <label for="s11">Karnataka</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Kerala" id="s12"
                                    {{ in_array('Kerala', $selectedStates) ? 'checked' : '' }}>
                                <label for="s12">Kerala</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Madhya Pradesh" id="s13"
                                    {{ in_array('Madhya Pradesh', $selectedStates) ? 'checked' : '' }}>
                                <label for="s13">Madhya Pradesh</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Maharashtra" id="s14"
                                    {{ in_array('Maharashtra', $selectedStates) ? 'checked' : '' }}>
                                <label for="s14">Maharashtra</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Manipur" id="s15"
                                    {{ in_array('Manipur', $selectedStates) ? 'checked' : '' }}>
                                <label for="s15">Manipur</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Meghalaya" id="s16"
                                    {{ in_array('Meghalaya', $selectedStates) ? 'checked' : '' }}>
                                <label for="s16">Meghalaya</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Mizoram" id="s17"
                                    {{ in_array('Mizoram', $selectedStates) ? 'checked' : '' }}>
                                <label for="s17">Mizoram</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Nagaland" id="s18"
                                    {{ in_array('Nagaland', $selectedStates) ? 'checked' : '' }}>
                                <label for="s18">Nagaland</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Odisha" id="s19"
                                    {{ in_array('Odisha', $selectedStates) ? 'checked' : '' }}>
                                <label for="s19">Odisha</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Punjab" id="s20"
                                    {{ in_array('Punjab', $selectedStates) ? 'checked' : '' }}>
                                <label for="s20">Punjab</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Rajasthan" id="s21"
                                    {{ in_array('Rajasthan', $selectedStates) ? 'checked' : '' }}>
                                <label for="s21">Rajasthan</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Sikkim" id="s22"
                                    {{ in_array('Sikkim', $selectedStates) ? 'checked' : '' }}>
                                <label for="s22">Sikkim</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Tamil Nadu" id="s23"
                                    {{ in_array('Tamil Nadu', $selectedStates) ? 'checked' : '' }}>
                                <label for="s23">Tamil Nadu</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Telangana" id="s24"
                                    {{ in_array('Telangana', $selectedStates) ? 'checked' : '' }}>
                                <label for="s24">Telangana</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Tripura" id="s25"
                                    {{ in_array('Tripura', $selectedStates) ? 'checked' : '' }}>
                                <label for="s25">Tripura</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Uttar Pradesh" id="s26"
                                    {{ in_array('Uttar Pradesh', $selectedStates) ? 'checked' : '' }}>
                                <label for="s26">Uttar Pradesh</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Uttarakhand" id="s27"
                                    {{ in_array('Uttarakhand', $selectedStates) ? 'checked' : '' }}>
                                <label for="s27">Uttarakhand</label>
                            </li>

                            <li>
                                <input type="checkbox" value="West Bengal" id="s28"
                                    {{ in_array('West Bengal', $selectedStates) ? 'checked' : '' }}>
                                <label for="s28">West Bengal</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Andaman and Nicobar Islands" id="s29"
                                    {{ in_array('Andaman and Nicobar Islands', $selectedStates) ? 'checked' : '' }}>
                                <label for="s29">Andaman and Nicobar Islands</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Chandigarh" id="s30"
                                    {{ in_array('Chandigarh', $selectedStates) ? 'checked' : '' }}>
                                <label for="s30">Chandigarh</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Dadra and Nagar Haveli and Daman and Diu"
                                    id="s31"
                                    {{ in_array('Dadra and Nagar Haveli and Daman and Diu', $selectedStates) ? 'checked' : '' }}>
                                <label for="s31">Dadra and Nagar Haveli and Daman and Diu</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Delhi" id="s32"
                                    {{ in_array('Delhi', $selectedStates) ? 'checked' : '' }}>
                                <label for="s32">Delhi</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Jammu and Kashmir" id="s33"
                                    {{ in_array('Jammu and Kashmir', $selectedStates) ? 'checked' : '' }}>
                                <label for="s33">Jammu and Kashmir</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Ladakh" id="s34"
                                    {{ in_array('Ladakh', $selectedStates) ? 'checked' : '' }}>
                                <label for="s34">Ladakh</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Lakshadweep" id="s35"
                                    {{ in_array('Lakshadweep', $selectedStates) ? 'checked' : '' }}>
                                <label for="s35">Lakshadweep</label>
                            </li>

                            <li>
                                <input type="checkbox" value="Puducherry" id="s36"
                                    {{ in_array('Puducherry', $selectedStates) ? 'checked' : '' }}>
...
<div class="modal fade" id="funderModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="select-wrapper w-100 position-relative">
                            ...
                            <ul class="select-list" style="display: none;">
                                <li data-value="government">
                                    Government
                                </li>

                                <li data-value="csr_corporate">
                                    CSR - Corporate
                                </li>

                                <li data-value="csr_psu">
                                    CSR - PSU
                                </li>

                                <li data-value="foreign_institutions">
                                    Foreign Institutions
                                </li>

                                <li data-value="individual_donor">
                                    Individual Donor
                                </li>

                                <li data-value="promoter_money">
                                    Promoter Money
                                </li>
                            </ul>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="select-wrapper w-100 position-relative">
                            ...
                            <ul class="select-list" style="display: none;">
                                ...
                                <li data-value="product_development">
                                    Product Development
                                </li>

                                <li data-value="working_capital">
                                    Working Capital
                                </li>

                                <li data-value="sales_marketing">
                                    Sales & Marketing
                                </li>

                                <li data-value="team_hiring">
                                    Team & Hiring
                                </li>
                                ...
                                <li data-value="business_expansion">
                                    Business Expansion
                                </li>

                                <li data-value="infrastructure">
                                    Infrastructure
                                </li>

                                <li data-value="research_development">
                                ...
                                <li data-value="project">
                                    Project
                                </li>

                                <li data-value="program">
                                    Program
                                </li>

                                <li data-value="org_development">
            ...
            <!-- Footer -->
            <div class="modal-footer border-0 d-flex justify-content-center justify-content-md-end gap-2 steps-btn mt-4 flex-wrap">
        ...
        <div class="modal-content border-0 consent">
            ...
            <div class="modal-body">
                ...
                <div class="consent-box">
                    ...
                    <p>PAN validation, Statutory registration verification, Background and compliance checks, Credit
                        bureau checks using the organization's PAN, where applicable, for the purpose of financial
                        assessment and risk evaluation</p>
                    <p>I grant Fundink the right to use our organization's details for:</p>
                    <p>Fundraising campaigns and curated funding calls, Promotional materials, website listings,
                        newsletters, and social media communication, Investor/funder presentations and ecosystem
                        reports, Showcasing case studies and impact highlights</p>
            ...
            <div
                class="modal-footer d-flex justify-content-center justify-content-md-end gap-2 gap-md-2 steps-btn mt-2 flex-wrap border-0">
                <div class="btn-wrap">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const checkboxes = document.querySelectorAll(
            '.checkbox-list:not(#domainCheckboxList) input[type="checkbox"]');
