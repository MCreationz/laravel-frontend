    ...
    <div class="modal fade" id="funderModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                    ...
                    <form id="funderForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="funder_year"
                                placeholder="Enter Year (e.g. 2026)" min="1000" max="9999"
                ...
                <div
                    class="modal-footer border-0 d-flex justify-content-center justify-content-md-end gap-2 steps-btn mt-4  flex-wrap">
