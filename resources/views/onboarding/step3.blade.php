            ...
            <div class="card p-3 p-md-4 border-0 mb-3 rounded-3">
                ...
                <div class="inner-fields mt-4 small-label">
                    ...
                    @php
                        ...
                        $ongoing = old('ongoing_year_revenue_lakh', $operationalDetail->ongoing_year_revenue_lakh ?? '');
                        $lastYear = old('last_year_revenue_lakh', $operationalDetail->last_year_revenue_lakh ?? '');
                        $lastToLast = old('last_to_last_year_revenue_lakh', $operationalDetail->last_to_last_year_revenue_lakh ?? '');
                    @endphp
                    ...
                    <div class="row mb-3 flex-wrap row-gap-3 row-gap-md-4 px-md-1">
                        ...
                        <div class="col-12 col-md-6 col-lg-3 px-md-2">
                            ...
                            <input type="number" name="lifetime_revenue_lakh"
                                ...
                                value="{{ $lifetime }}" placeholder="Enter Amount" required>
                        ...
                        <div class="col-12 col-md-6 col-lg-3 px-md-2">
                            ...
                            <input type="number" name="last_to_last_year_revenue_lakh"
                                ...
                                value="{{ $lastToLast }}" placeholder="Enter Amount" required>
            ...
            <div class="card p-3 mb-3 p-md-4 border-0 rounded-3" id="non_profit_donation">
                ...
                <div class="inner-fields mt-md-4 small-label">
                    ...
                    @php
                        ...
                        $foreign = old('foreign_donations_institutional', $operationalDetail->foreign_donations_institutional ?? 0);
                        ...
                        $total = old(
                            'total_funding_lakh',
                            ($govt + $foreign + $promoters + $individual)
                        );
                    @endphp
            ...
            <div class="card p-3 mb-3 p-md-4 border-0 rounded-3" id="profit_donation">
                ...
                <div class="inner-fields mt-md-4 small-label">
                    ...
                    @php
                        ...
                        $bootstrapped = old('bootstrapped_friends_family', $operationalDetail->bootstrapped_friends_family ?? 0);
                        $debt = old('debt', $operationalDetail->debt ?? 0);

                        $total = old(
                            'total_funding_lakh',
                            ($grants + $equity + $bootstrapped + $debt)
                        );
                    @endphp
